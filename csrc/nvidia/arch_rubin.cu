...
// NVIDIA Rubin (sm_120 / Rubin Ultra) CPX 3.6TB/s NVLink 6 Multicast Path
extern "C" NexusKVHalStatus nexuskv_cuda_register_rubin(uint64_t handle_id, void* ptr,
    ...
    out_handle->micro_arch = NEXUSKV_ARCH_NVIDIA_RUBIN;
