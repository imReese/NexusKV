...
from nexuskv.planner.cost import CostEstimator, CostEstimateResult
...
class CacheAwareRouter:
    ...
    def calculate_shared_prefix_length(self, prompt_tokens: list[int], worker_prefix_tokens: list[int]) -> int:
        match_len = 0
    ...
    def select_best_worker(
        ...
        for worker in candidate_workers:
            prefix_len = self.calculate_shared_prefix_length(prompt_tokens, worker.cached_prefix_tokens)
            ...
            net_gain = (cost_res.t_recompute_seconds - cost_res.t_cache_seconds) * 1000.0 - load_penalty_ms
        ...
        return RoutingDecision(
            ...
            is_cache_hit=is_hit,
            cost_detail=best_cost_res or self.cost_estimator.estimate(total_tokens, total_tokens * 256, TierKind.HOST_DRAM, TierKind.DEVICE),
        )
