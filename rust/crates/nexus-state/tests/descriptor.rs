use nexus_state::{
    ...
    QuantizationMetadata, SCHEMA_VERSION, StateSemanticType, TensorRole, TensorSpec, TierKind,
    TransferBackend, TransferCapability, TransferPath, supports_partial_materialization,
    validate_descriptor,
};
